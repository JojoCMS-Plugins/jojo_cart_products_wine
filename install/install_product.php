...
$query = "
    CREATE TABLE {product} (
        ...
        `pr_designation` VARCHAR(255) NOT NULL default '',
        `pr_variety` VARCHAR(255) NOT NULL default '',
        `pr_vintage` VARCHAR(10) NOT NULL default '',
        `pr_class` enum('white','red','dessert','rose') NOT NULL default 'white',
        `pr_display_order` int(4) NOT NULL default '0',
        `pr_desc` text NOT NULL,
        `pr_url` VARCHAR(255) NOT NULL default '',
        `pr_body` text NULL,
        `pr_body_code` text NULL,
        `winemaker` VARCHAR(100) NOT NULL default '',
        `winemaking` text NULL,
        `alcohol` VARCHAR(20) NOT NULL default '',
        `ph` VARCHAR(20) NOT NULL default '',
        `ta` VARCHAR(20) NOT NULL default '',
        `sugar` VARCHAR(20) NOT NULL default '',
        `viticulturist` VARCHAR(100) NOT NULL default '',
        `viticulture` text NULL,
        `brix` VARCHAR(20) NOT NULL default '',
        `harvestdate` VARCHAR(100) NOT NULL default '',
        `tasting` text NULL,
        `foodmatch` text NULL,
