...
<div class="wines">
    ...
    {if $wine.pr_price > 0}[[buynowlink: {$wine.pr_code}]] Bottle Price: {$currencysymbol}{$wine.pr_price}
    {/if}
    {if $wine.pr_caseprice > 0}[[buynowlink: {$wine.pr_code}_case]] Case Price ({$wine.pr_casesize} bottles): {$currencysymbol}{$wine.pr_caseprice}
    {/if}
